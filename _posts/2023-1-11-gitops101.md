...
date: "2023.01.11"
image: ../assets/images/gitops-series/devops-one.jpg
---

> *Before we get into **GitOps**, we need to explain what **DevOps** is and why we need **DevOps**.*

![This image is taken from AWS](/assets/images/gitops-series/ci-cd.jpg)
...
![IaC](/assets/images/gitops-series/iac.png)
...
![ArgoCD & Flux](/assets/images/gitops-series/argo-flux.png)
